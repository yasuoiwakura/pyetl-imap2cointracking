...
4. Extract values from the email body:
   - amount
   - gold price
   - gold quantity bought this time
   - totals
5. Export the data as a CoinTracking-compatible CSV.
6. (not implented: write into cointracking API)
...
Github link for internal reference: [repo-link-public]

[repo-link-public]: https://github.com/yasuoiwakura/pyetl-imap2cointracking
